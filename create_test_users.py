...
def create_test_users():
    ...
    try:
        ...
        worker_user.nom = 'Kouassi'
        worker_user.prenom = 'Jean'
        ...
        print(f"✅ Worker created/updated: {worker_email} / Worker123!")
    ...
    try:
        ...
        apprentice_user.nom = 'Sow'
        apprentice_user.prenom = 'Moussa'
        ...
        print(f"✅ Apprentice created/updated: {apprentice_email} / Apprentice123!")
    except Exception as e:
        print(f"❌ Error creating Apprentice: {e}")
    ...
    try:
        ...
        client_user.save()
        print(f"✅ Client created/updated: {client_email} / Client123!")
    except Exception as e:
